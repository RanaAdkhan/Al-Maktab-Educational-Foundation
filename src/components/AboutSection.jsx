      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-100 text-amber-900 text-xs sm:text-sm font-bold mb-3 border border-amber-300">
            ...
            <span>ہمارا تعارف اور مقاصد</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center mb-14">
          ...
          <div className="lg:col-span-7 space-y-5 text-right">
            <h3 className="text-xl sm:text-2xl font-black text-slate-900 leading-snug">
              بااعتماد، باوقار اور شرعی اصولوں کے مطابق رشتہ خدمات کا مرکز
            </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="bg-amber-50/80 p-5 rounded-3xl border border-amber-200/80">
                ...
                <h4 className="text-base font-black text-slate-900 mb-1">ہمارا مشن</h4>
              ...
              <div className="bg-emerald-50/80 p-5 rounded-3xl border border-emerald-200/80">
                ...
                <h4 className="text-base font-black text-slate-900 mb-1">ہمارا وژن</h4>
                <p className="text-xs text-slate-700 leading-relaxed">
          ...
          {/* Left Visual / Office & Foundation Badge Card */}
          <div className="lg:col-span-5 bg-gradient-to-br from-slate-900 via-slate-800 to-amber-950 text-white p-7 sm:p-9 rounded-3xl shadow-2xl border-2 border-amber-500 relative overflow-hidden text-right">
            ...
            <h4 className="text-xl font-black text-amber-400 text-center mb-1">
              المکتب ایجوکیشنل فاؤنڈیشن
            </h4>
            <p className="text-xs text-slate-300 text-center mb-6">
              رجسٹرڈ بااعتماد ادارہ برائے فلاحی و ازدواجی خدمات
            </p>

            <div className="space-y-3 text-xs border-t border-white/15 pt-4">
              <div className="flex items-start gap-2.5">
                <MapPin className="w-4 h-4 text-amber-400 shrink-0 mt-1" />
                <span><strong>مرکزی دفتر:</strong> {siteConfig.address}</span>
              </div>
              <div className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-amber-400 shrink-0" />
                <span><strong>لینڈ لائن:</strong> <span dir="ltr">{LANDLINE_PHONE}</span></span>
              </div>
              <div className="flex items-center gap-2.5">
                <MessageCircle className="w-4 h-4 text-emerald-400 shrink-0" />
                <span><strong>واٹس ایپ:</strong> <span dir="ltr">{siteConfig.whatsapp}</span></span>
              </div>
            </div>
            ...
            >
              <span>آن لائن رشتہ رجسٹر کریں</span>
            </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {aboutFoundation.features.map((feat, i) => (
            <div
              key={i}
              className="bg-slate-50 p-5 rounded-3xl border border-slate-200 hover:border-amber-400 hover:shadow-md transition-all text-right"
            >
